const checkIcon = (
  <svg width="8" height="6" viewBox="0 0 8 6" className="fill-golden">
...
const crossIcon = (
  <svg width="7" height="7" viewBox="0 0 8 8" className="fill-golden">
...
const OfferList = ({
  ...
  return (
    <div className="mb-3 flex items-center">
      <span className="mr-3 flex h-[18px] w-full max-w-[18px] items-center justify-center rounded-full bg-golden bg-opacity-10 text-primary">
