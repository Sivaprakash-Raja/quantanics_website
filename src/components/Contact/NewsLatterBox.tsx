  ...
  return (
    <div className="relative z-10 rounded-sm bg-white p-8 shadow-three dark:bg-gray-dark sm:p-11 lg:p-8 xl:p-11">
      ...
      <p className="mb-11 border-b border-body-color border-opacity-25 pb-11 text-base leading-relaxed text-body-color dark:border-white dark:border-opacity-25">
        Be the first to know about our newest products, promotions, and helpful resources. Don't miss out—subscribe today and stay connected with us!
      </p>
      <div>
        <input
          type="text"
        ...
        <input
          type="submit"
          value="Subscribe"
          className="mb-5 flex w-full cursor-pointer items-center justify-center rounded-sm bg-golden px-9 py-4 text-base font-bold text-black shadow-submit duration-300 hover:bg-primary/90 dark:shadow-submit-dark"
        />
